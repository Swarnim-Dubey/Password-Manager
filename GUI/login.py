...
from GUI.vault import VaultWindow
from GUI.signup import SignupWindow
from GUI.forgot_password import ForgotPasswordWindow   # ✅ NEW
...
class LoginWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.username_input = QLineEdit()
        self.username_input.setPlaceholderText("Username or Email")  # ✅ UPDATED
        ...
        forgot_btn = QPushButton("Forgot Password?")   # ✅ NEW
        ...
        layout.addWidget(self.password_input)
        layout.addWidget(login_btn)
        layout.addWidget(forgot_btn)   # ✅ NEW
        layout.addWidget(signup_btn)
